...
class BaseApplicationPage {
    ...
    initialize() {
        ...
        $("[data-control=collapsible-checkboxes]").each((i, e) => this.enableCollapsibleCheckboxes($(e)));
        ...
        $("[data-change-action][data-control=collapsible-checkboxes]").off("ccl.change.data-action").off("change.data-action").on("ccl.change.data-action", (e) => this.invokeActionWithAjax(e, $(e.currentTarget).attr("data-change-action")));
    ...
    enableCollapsibleCheckboxes(input: any) {
