namespace AppData
{
    ...
    public class SettingsDataProvider : SqlDataProvider<Domain.Settings>
    {
        #region SQL Commands
        ...
        internal void FillData(IDataReader reader, Domain.Settings entity)
        {
            var values = new object[reader.FieldCount];
            reader.GetValues(values);
            
            entity.Name = values[Fields.Name] as string;
            entity.PasswordResetTicketExpiryMinutes = (int)values[Fields.PasswordResetTicketExpiryMinutes];
            entity.CacheVersion = (int)values[Fields.CacheVersion];
        }
        ...
        async Task Insert(Domain.Settings item)
        {
        ...
        async Task Update(Domain.Settings item)
        {
        ...
        static class Fields
        {
            ...
            public const int PasswordResetTicketExpiryMinutes = 2;
